 ...
 */
static struct buffer_head *
__find_get_block_common(struct block_device *bdev, sector_t block,
...
{
	return __find_get_block_common(bdev, block, size, true);
}
EXPORT_SYMBOL(__find_get_block);

/* same as __find_get_block() but can sleep */
struct buffer_head *
__find_get_block_nonatomic(struct block_device *bdev, sector_t block,
			   unsigned size)
{
	return __find_get_block_common(bdev, block, size, false);
}
